<x-layout>
    <header class="relative bg-gray-800 after:pointer-events-none after:absolute after:inset-x-0 after:inset-y-0 after:border-y after:border-white/10">
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <h1 class="text-3xl font-bold tracking-tight text-white">Create New Writing Prompt</h1>
        </div>
    </header>
    <main>
            ...
            <div class="bg-gray-800 rounded-lg shadow-md p-6">
                <form method="POST" action="/admin/prompts">
                    ...
                    <x-form-field>
                        ...
                        <x-form-textarea name="prompt" id="prompt" rows="5" required>{{ old('prompt') }}</x-form-textarea>
                    ...
                    <div class="flex justify-end mt-6">
                        ...
                        <x-form-button>Create Prompt</x-form-button>
                    </div>
                </form>
            </div>
        </div>
